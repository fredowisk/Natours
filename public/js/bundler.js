...
var displayMap = function displayMap(locations) {
  ...
  var newButton = document.getElementById('zoom');
...
var updateUserPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(oldPassword, newPassword, newPasswordConfirmation) {
    var result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var stripe = Stripe('pk_test_51Ju4syCxZBGB882laYkpbTlJpD80i5TElbw2A83xJMZAX1hvr5kMoS0fOoGtwtdzK5jj4w3NUoIc3NSOZmbmNaAm00qLIxFEcB');
...
if (signUpForm) {
  ...
  var _icon = document.querySelectorAll('#password-icon');

  _icon[0].addEventListener('click', function () {
    if (password.type === 'password') {
      password.type = 'text';
      _icon[0].firstChild.attributes[0].nodeValue = '/img/icons.svg#icon-eye-off';
    } else {
      password.type = 'password';
      _icon[0].firstChild.attributes[0].nodeValue = '/img/icons.svg#icon-eye';
    }
  });

  _icon[1].addEventListener('click', function () {
    if (passwordConfirmation.type === 'password') {
      passwordConfirmation.type = 'text';
      _icon[1].firstChild.attributes[0].nodeValue = '/img/icons.svg#icon-eye-off';
    } else {
      passwordConfirmation.type = 'password';
      _icon[1].firstChild.attributes[0].nodeValue = '/img/icons.svg#icon-eye';
    }
  });
...
if (updatePasswordForm) updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var submitButton, oldPassword, newPassword, newPasswordConfirmation;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            oldPassword = document.getElementById('password-current');
            newPassword = document.getElementById('password');
            newPasswordConfirmation = document.getElementById('password-confirm');
            _context.next = 8;
            return (0, _updateSettings.updateUserPassword)(oldPassword.value, newPassword.value, newPasswordConfirmation.value);
